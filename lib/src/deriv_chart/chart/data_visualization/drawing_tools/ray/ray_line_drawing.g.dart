...
part of 'ray_line_drawing.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

RayLineDrawing _$RayLineDrawingFromJson(Map<String, dynamic> json) =>
    RayLineDrawing(
...
Map<String, dynamic> _$RayLineDrawingToJson(RayLineDrawing instance) =>
    <String, dynamic>{
